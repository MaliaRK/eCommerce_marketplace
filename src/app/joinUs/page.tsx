...
const JoinUs = () => {
  return (
    <div className='max-w-[1440px] md:mx-[30%] text-[#cccccc]'>
      ...
      <div className='mx-[10%]'>
        <p><input type="email" placeholder='Email address' className='my-4 border-[#cccccc] border-[1px] outline-none py-2 md:py-1 pl-1 pr-36 rounded-md' /></p>
        <p><input type="password" placeholder='Password' className='my-4 border-[#cccccc] border-[1px] outline-none py-2 md:py-1 pl-1 pr-36 rounded-md' /></p>
        ...
        <p><input type="text" placeholder='Date of Birth' className='my-4 border-[#cccccc] border-[1px] outline-none py-2 md:py-1 pl-1 pr-36 rounded-md' /></p>
        <p>Get a Nike Member Reward every year on your Birthday.</p>
        <p><input type='text' placeholder='Pakistan' className='my-4 border-[#cccccc] border-[1px] outline-none py-2 md:py-1 pl-1 pr-36 rounded-md' /></p>  
