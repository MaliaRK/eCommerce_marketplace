...
const ProductDetail = () => {
  return (
    <div className='max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-[40%_auto] '> 
        <Image src='/1.png' alt='hero' width={300} height={10} className='mx-auto md:mr-0 md:w-[400px]'></Image>
        <div className='mx-10 mt-10 md:my-auto'>
            <h3 className='text-2xl'><strong>Nike Air Force 1 PLT.AF.ORM</strong></h3>
            <p className='my-4 text-s'>Turn style on its head with this crafted take on the Air 
            ...
            <Link href='./cart'><button className='bg-black text-white rounded-full px-4 py-1 my-3 flex gap-1 items-center'>
